...
urlpatterns = patterns('',
  url(r'^$', permission_required('sharing.lending_list')(views.LendingList.as_view()), name='lending_list'),
  ...
  url(r'^lending/end/(?P<lending_id>\d+)$', permission_required('sharing.end_lending')(views.end_lending), name='lending_end'),
